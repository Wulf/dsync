...
pub struct TableOptions<'a> {
    ...
    /// Generates create structs without primary key
    create_no_pk: Option<bool>,
}
...
impl<'a> TableOptions<'a> {
    ...
    pub fn get_create_no_pk(&self) -> bool {
        self.create_no_pk.unwrap_or_default()
    }
    ...
    pub fn create_no_pk(self) -> Self {
        Self {
            create_no_pk: Some(true),
            ..self
        }
    }
    ...
    pub fn apply_defaults(&self, other: &TableOptions<'a>) -> Self {
        Self {
            ...
            create_no_pk: self.create_no_pk.or(other.create_no_pk),
